...
namespace Yacht.Migrations
{
    public class BasesController : Controller
    {
        ...
        public BasesController(YachtContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Naziv")] Base @base)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naziv")] Base @base)
        {
            if (id != @base.Id)
            {
                return NotFound();
